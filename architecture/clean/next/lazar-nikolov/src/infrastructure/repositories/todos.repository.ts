#! репозиторий по обращению к бд (todo)
...
// обращения к entities
import { TodoInsert, Todo } from '@/src/entities/models/todo';
import type { IInstrumentationService } from '@/src/application/services/instrumentation.service.interface';
import type { ICrashReporterService } from '@/src/application/services/crash-reporter.service.interface';

//класс описывает взаимодействие с БД
export class TodosRepository implements ITodosRepository {
  //класс принимает в себя IInstrumentationService, ICrashReporterService для логирования
  constructor(
