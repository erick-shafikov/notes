...
- [attr] ищет элементы с указаным атрибутом
...
- запятая – группировка
- пробел – выбор всех потомков
- > - дочерние (непосредственно прямые потомки)
- ~ - выбор всех одноуровневых
- - - выбор первого соседнего элемента
