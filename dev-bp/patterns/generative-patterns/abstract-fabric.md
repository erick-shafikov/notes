...
без указания для них конкретных классов. Шаблон описывает способ инкапсулирования группы индивидуальных фабрик, объединённых некой темой, без указания для них конкретных классов. Предоставляет метод фабрики для создания объектов или классов, которые связаны или зависимы, не уточняя конкретный класс.
