...
- - dns-prefetch
- - expect - Позволяет блокировать отрисовку страницы до тех пор, пока не будут обработаны основные части документа, чтобы обеспечить согласованную отрисовку. Обратите внимание, что блокировка отрисовки происходит только при наличии атрибута blocking="render"
...
Синтаксис - атрибуты name и content. Существую og метаданные open graph для facebook, так же есть у твиттера
...
- async - Это логический атрибут, указывающий браузеру, если возможно, загружать скрипт, указанный в атрибуте src, асинхронно. Не останавливает парсинг HTML. Порядок обработки не гарантирован
...
- type - по умолчанию js, другие типы:
