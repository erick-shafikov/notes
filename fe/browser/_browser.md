...
Процесс браузера - это главный процесс, который отвечает за работу пользовательского интерфейса. Порядок скачивания синхронный, но браузер может распараллелить загрузку разметки с загрузкой js, css.
