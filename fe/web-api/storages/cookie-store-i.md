...
- Запись обновляет только упомянутые куки, но не затрагивает все остальные document.cookie = “user-John”; имя и значения – любые символы – для формирования можно использовать encodeURIComponent. Ограничение – 4кб на одну пару, ограничение 20+ пар
