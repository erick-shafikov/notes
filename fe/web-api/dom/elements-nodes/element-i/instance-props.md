...
⇒ HTMLCollection состоящая из дочерних элементов, коллекция детей, которые являются элементами
...
elem.classList.contains("class"); //- проверка на наличие, вернет true если elemB находится внутри elemA
```
