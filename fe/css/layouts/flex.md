...
- По умолчанию – flex: 0 1 auto - элемент не растягивается, но сжимается, когда места недостаточно (это по умолчанию - initial)
- flex: auto === flex: 1 1 auto - пространство распределится равномерно, но больший займет больше места. Элемент сжимается если места нехватает
...
по умолчанию - auto, но можно указать как 0, что бы указать что элемент может быть уже чем содержимое

# flex и margin

- margin-auto позволит откинуть элемент в начало/конец сетки без растягивания
