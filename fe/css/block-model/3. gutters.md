...
- !!! если padding задан в процентах, то считается от ширины элемента
...
Группа свойств - corner-bottom-left-shape, corner-bottom-right-shape, corner-top-left-shape, corner-top-right-shape, corner-start-start-shape, corner-start-end-shape, corner-end-start-shape, corner-end-end-shape, corner-top-shape, corner-right-shape, corner-bottom-shape, corner-left-shape, corner-block-start-shape, corner-block-end-shape, corner-inline-start-shape
...
Значение регулируется border-radius

- scoop - обрезка в стиле border-radius
- notch - обрезка прямоугольная, то есть убирает угол
- superellipse() - функция которая принимает значения:
- - положительные целые числа - круглая обрезка (как Border-radius) в соотношении длина/ширина
- - 0 - обрезка краев по прямой (убирает треугольник)
- - отрицательные целые - круглая обрезка в соотношении длина/ширина внутрь
- - Infinity - прямоугольная обрезка (notch)
- - целые от 0 до 1 - округлая угловая обрезка, по форме 0, но закругленная
- - целые от -1 до 0 - округлая угловая обрезка внутрь, по форме 0, но закругленная
- - целые меньше -1 - все больше ближе к прямоугольной
