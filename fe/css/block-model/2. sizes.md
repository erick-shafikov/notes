...
- !!! box-sizing: border-box может не подойти, когда на мобильной верстке нужно учесть рамки
...
позволяет настроить пропорции контейнера, предпочтительное соотношения сторон
...
- !!! Стоит учитывать aspect-ratio контейнер с контентом внутри, лечится overflow
- !!! flex контейнер растянет по максимальному элементу, лечится min-height:0
