...
- - 401 - не авторизован, заголовки связанные с ответом:
- - - [Authorization](./headers/req-headers.md#authorization)
- - 402 - используется редко, для платежных систем
- - 403 - нет прав к ресурсу
- - 404 - нет ресурса
- - 405 - метод не поддерживается, заголовки связанные с ответом:
- - - [Allow](./headers/res-headers.md#allow)
- - 406 - нет контента для UA, ответ может быть в случае заголовков:
...
- - 415 - медиа формат не поддерживается, ответ может быть в случае заголовков:
