...
domain name system - На уровне интернет работает с ip, dns позволяет преобразовать ip в читаемый вид. Использует udp на транспортном уровне (возможно tcp для безопасности). Работает по модели запрос - ответ. Три элемента инфраструктуры взаимодействия:
...
Все данные передается в открытом, бинарном виде
...
- Комбинированный вариант DOH + DNSSEC
