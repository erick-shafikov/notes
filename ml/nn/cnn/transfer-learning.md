...
Берется уже обученная НС выделяются полносвязные слои и обучаются они, сверточные остаются с пред-обученными весами
...
# отключаем обучение у сверточных слоев
model.requires_grad_(False)
# !!! transfer
# меняем последний слой fc - на 10 категории, у исходного resnet50 их 1000 на выходе
