...
Тогда обратная матрица $\Sigma^{-1}$ тоже диагональна — просто обратные значения на диагонали:

$$\Sigma^{-1} = \begin{pmatrix}1/\sigma_{x_1}^2 & 0 & \cdots & 0 \\ 0 & 1/\sigma_{x_2}^2 & \cdots & 0 \\ \vdots & & \ddots & \vdots \\ 0 & \cdots & 0 & 1/\sigma_{x_n}^2\end{pmatrix}$$

Квадратичная форма при этом распадается в сумму — внедиагональные слагаемые обнуляются:

$$(x - \mu)^T \Sigma^{-1}(x - \mu) = \sum_{i=1}^n \frac{(x_i - \mu_i)^2}{\sigma_{x_i}^2}$$

А экспонента суммы — это произведение экспонент:

$$\exp\!\left\{-\frac{1}{2}\sum_{i=1}^n \frac{(x_i - \mu_i)^2}{\sigma_{x_i}^2}\right\} = \prod_{i=1}^n \exp\!\left\{-\frac{(x_i - \mu_i)^2}{2\sigma_{x_i}^2}\right\}$$

Это и есть произведение одномерных гауссиан — в точности предположение Наивного Байеса о независимости признаков:

$$P(x \mid y) = \prod_{i=1}^n p(x_i \mid y)$$

Т.е. Наивный Байес — частный случай гауссовского байесовского классификатора с диагональной $\Sigma_y$.
...
Пример (2 класса, 2 признака) [5-multivariate-normal.md — пример $2\times2$](../../../math/prob-math-stat/probability/multivariate-probability/5-multivariate-normal.md): построение $\Sigma$ из $\sigma^2$ и $r$, вычисление определителей, обратных матриц и классификация тестовой точки $x=[0,0]^T$.
