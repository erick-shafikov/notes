...
![Распределения скоров и точки на ROC при разных порогах](roc-threshold.png)
...
![Таблица ранжирования и построение шаговой кривой](roc-ranking.png)
...
![ROC-кривые: идеальная, реальная и случайная](roc-curves.png)
